...
const ExpensesPage: React.FC = () => {
      ...
      const handleExportExcel = () => {
            const dataToExport = displayedExpenses.map((expense: Expense) => ({
                  'Tarih': expense.date.toDate().toLocaleDateString('tr-TR'),
                  'Açıklama': expense.description,
                  'Tür': expense.type,
                  'Tutar': expense.amount,
                  'Para Birimi': expense.currency,
                  'Durum': expense.status === 'PAID' ? 'Ödendi' : 'Bekliyor',
            ...
            XLSX.writeFile(wb, `Giderler_${today}.xlsx`);
      };
